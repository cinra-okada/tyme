...
function change_post_object_label() {
	...
	$labels->add_new_item = '新規追加：NEWS';
	$labels->edit_item = '編集：NEWS';
...
//カスタム投稿タイプ
include "custom_post_tax.inc";

set_post_type_list(array(
	array("works","WORKS"),
));

set_custom_category_list(array(
	array("wokscategory","カテゴリー","works"),
));

set_custom_tag_list(array(
	array("wokstag","タグ","works"),
));